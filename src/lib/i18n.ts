...
const labels = {
  es: {
    ...
    certifications: "Certificaciones", professionalCertificates: "Certificados profesionales", skills: "Habilidades", projects: "Proyectos independientes", complementaryExperience: "Experiencia complementaria", complementaryEducation: "Formación complementaria",
    ...
    courses: "Cursos", hobbies: "Hobbies", projectsCount: "proyectos", current: "Actual", specializations: "Especializaciones", issuedBy: "Emitido por", taughtBy: "Impartido por",
  },
  en: {
    profile: "Professional profile", experience: "Professional experience", education: "Education",
    certifications: "Certifications", professionalCertificates: "Professional certificates", skills: "Skills", projects: "Independent projects", complementaryExperience: "Complementary experience", complementaryEducation: "Complementary education",
    ...
    courses: "Courses", hobbies: "Interests", projectsCount: "projects", current: "Present", specializations: "Specializations", issuedBy: "Issued by", taughtBy: "Taught by",
  },
} as const
